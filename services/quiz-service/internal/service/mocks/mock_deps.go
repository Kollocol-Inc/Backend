...
//
//	mockgen -source=internal/service/quiz_service.go -destination=internal/service/mocks/mock_deps.go -package=mocks RabbitMQPublisher,UserClient,TemplateRepo,InstanceRepo,DeleteRepo
//
...
import (
	context "context"
	model "quiz-service/internal/model"
...
func (m *MockUserClient) GetGroupMemberIDs(ctx context.Context, groupID string) ([]string, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "GetGroupMemberIDs", ctx, groupID)
	ret0, _ := ret[0].([]string)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}
...
func (mr *MockUserClientMockRecorder) GetGroupMemberIDs(ctx, groupID any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "GetGroupMemberIDs", reflect.TypeOf((*MockUserClient)(nil).GetGroupMemberIDs), ctx, groupID)
}

// GetNotificationSettingsBatch mocks base method.
func (m *MockUserClient) GetNotificationSettingsBatch(ctx context.Context, userIDs []string) (map[string]model.NotificationSettings, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "GetNotificationSettingsBatch", ctx, userIDs)
	ret0, _ := ret[0].(map[string]model.NotificationSettings)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}

// GetNotificationSettingsBatch indicates an expected call of GetNotificationSettingsBatch.
func (mr *MockUserClientMockRecorder) GetNotificationSettingsBatch(ctx, userIDs any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "GetNotificationSettingsBatch", reflect.TypeOf((*MockUserClient)(nil).GetNotificationSettingsBatch), ctx, userIDs)
}

// GetUsersByIDs mocks base method.
func (m *MockUserClient) GetUsersByIDs(ctx context.Context, userIDs []string) (map[string]*model.UserInfo, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "GetUsersByIDs", ctx, userIDs)
	ret0, _ := ret[0].(map[string]*model.UserInfo)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}
...
func (m *MockDeleteRepo) DeleteAllByOwner(ctx context.Context, userID string) error {
	m.ctrl.T.Helper()
...
func (mr *MockDeleteRepoMockRecorder) DeleteAllByOwner(ctx, userID any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "DeleteAllByOwner", reflect.TypeOf((*MockDeleteRepo)(nil).DeleteAllByOwner), ctx, userID)
}
